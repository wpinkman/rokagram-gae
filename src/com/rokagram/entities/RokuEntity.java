...
public class RokuEntity extends EntityBase {
   ...
   public String toString() {
      return "RokuEntity [deviceId=" + deviceId + ", model=" + model + ", displayMode=" + displayMode + ", firmware=" + firmware
            + ", country=" + country + ", region=" + region + ", city=" + city + ", latlong=" + latlong + ", audioMinutes=" + audioMinutes
            + ", users=" + users + "]";
   }
